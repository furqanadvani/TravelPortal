...
export const getHodEmployees = (payload = {}) => async (dispatch) => {
  ...
  try {
    const url = payload.empId
      ? `/department/hod/${payload.empId}/employees`
      : `/department/hod/employees`;
...
export const clearHodEmployees = () => (dispatch) => {
  dispatch({
    type: DEPARTMENTS.CLEAR_HODS_EMPLOYEES,
  });
};

export const clearHod = () => (dispatch) => {
  dispatch({
    type: DEPARTMENTS.CLEAR_HODS_EMPLOYEES,
  });
};