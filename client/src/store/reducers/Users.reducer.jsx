...
const initialState = {
    ...
    updateAccessRightsFormLoading : false,

    saveEmployementDetailsLoading : false
};
...
export default (state = initialState, action = {}) => {
    switch (action.type) {
        ...
        case USERS.UPDATE_USER_ACCESS_RIGHTS:
            return {
                ...state,
                updateAccessRightsFormLoading: action.loading,
            };
        case USERS.SAVE_EMPLOYEMENT_DETAILS:
            return {
                ...state,
                saveEmployementDetailsLoading: action.loading,
            };
