...
const AddDepartmentMember = ({ isOpenAddModal, setIsOpenAddModal, departmentId }) => {
    ...
    const handleSubmit = (values) => {
        ...
        dispatch(addDepartmentMember(payload, callBack));
    };
                        ...
                        {({
                            ...
                            <AntForm layout="vertical" onFinish={handleSubmit}>
                                ...
                                <CSelect
                                    ...
                                    label="Is already a (KP) microsoft user?"
                                    placeholder="Is already a (KP) microsoft user?"
                                    ...
                                    error={submitCount ? errors.isKamelPayMicrosoftUser : touched.isKamelPayMicrosoftUser && errors.isKamelPayMicrosoftUser}
                                >
                                </CSelect>
